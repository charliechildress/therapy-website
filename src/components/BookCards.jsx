      ...
      {books.map((book, index) => {
        if (index % 2 === 0) {
          return (
            ...
            >
              <div className="flex flex-row lg:flex-col md:flex-col sm:flex-col xs:flex-col relative px-10 sm:px-2 xs:px-2 bg-card-bg w-full min-h-[250px] shadow-[20px_0px_100px_rgba(146,128,94,0.7)] border-4 rounded-lg border-card-border">
                <div className="flex-0 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] w-1/2 lg:w-full md:w-full sm:w-full xs:w-full pt-7">
                  ...
                  <p className="flex flex-row font-serif 3xl:space-x-10 2xl:space-x-7 space-x-5 md:space-x-3 sm:space-x-2 mb-2 flex-auto pt-8 sm:pt-4 text-card-text">
                    {book.tags.map((tag) => (
                      <p
          ...
          return (
            <motion.div
              ...
              className="flex pb-20"
            >
              <div className="flex flex-row lg:flex-col md:flex-col sm:flex-col xs:flex-col relative px-10 sm:px-6 xs:px-6 bg-card-bg w-full min-h-[250px] shadow-[20px_0px_100px_rgba(146,128,94,0.7)] border-4 rounded-lg border-card-border">
